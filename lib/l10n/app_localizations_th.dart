...
class AppLocalizationsTh extends AppLocalizations {
  ...
  String get helpBackupBody =>
      'ใช้「สร้างข้อมูลสำรอง」ในหน้าตั้งค่าเพื่อบันทึกแชทและไฟล์แนบทั้งหมดที่นำเข้าไว้เป็นไฟล์เดียว ใช้「กู้คืนจากข้อมูลสำรอง」เพื่อนำข้อมูลเดียวกันไปยังเครื่องใหม่';
